...
% 
% Output:
% x - column vector of blue noise samples with unity  
%     standard deviation and zero mean value 
%
% The function generates a column vector of blue noise samples.
% In terms of power at a constant bandwidth, the blue noise 
% increases in by 3 dB/oct i.e., 10 dB/dec.
