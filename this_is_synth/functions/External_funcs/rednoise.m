...
%
% Output:
% x - column vector of red noise samples with unity  
%     standard deviation and zero mean value 
%
% The function generates a column vector of red (Brownian) noise 
% samples. In terms of power at a constant bandwidth, the red  
% noise falls off by -6 dB/oct i.e., -20 dB/dec.
