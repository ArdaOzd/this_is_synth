...
%
% Output:
% x - column vector of violet noise samples with unity  
%     standard deviation and zero mean value 
%
% The function generates a column vector of violet noise samples.
% In terms of power at a constant bandwidth, the violet noise 
% increases in by 6 dB/oct i.e., 20 dB/dec.
